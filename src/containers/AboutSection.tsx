          ...
          <div className="flex flex-col md:flex-row items-center mb-6">
            ...
            <div>
              <p className="text-gray-300 text-lg leading-relaxed mb-4">
                Hi, I'm Shivansh Saini, a passionate developer with expertise in
                React, Unity, Android development, and creative coding. I love
                building immersive experiences that blend technology and design.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed mb-4">
                With a strong foundation in both frontend and backend
                technologies, I enjoy tackling complex challenges and turning
                ideas into reality through code. My journey in development has
                allowed me to work on diverse projects ranging from mobile
                applications to web platforms and game development.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="bg-gray-700 p-4 rounded-lg">
              ...
              <p className="text-gray-300 text-sm">
                Proficient in modern JavaScript frameworks like React, with
                experience in building responsive and performant web
                applications.
              </p>
            </div>
            ...
            <div className="bg-gray-700 p-4 rounded-lg">
              ...
              <p className="text-gray-300 text-sm">
                Experienced in Unity game development with a focus on creating
                engaging gameplay mechanics and immersive experiences.
              </p>
            </div>
            ...
            <div className="bg-gray-700 p-4 rounded-lg">
              ...
              <p className="text-gray-300 text-sm">
                Skilled in Android development using Java and Flutter, with a
                focus on creating intuitive and user-friendly mobile
                applications.
              </p>
            </div>
